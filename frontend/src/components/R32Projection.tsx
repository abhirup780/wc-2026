...
import type { R32Matchup } from '@wc2026/shared';
...
/**
 * Round-of-32 "most likely ties" — a compact section of the Forecast tab.
 * Global ranking: how often each exact two-team pairing forms in the R32 across
 * sims. Top 6 by default (high→low); the rest behind "Show more".
 */
